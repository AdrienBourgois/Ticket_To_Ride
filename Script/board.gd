...
func create_world():
	...
	_add_path({ "pos": Vector3(-12, 0, 8), "Rotation": 15, "NbrSpace": 2, "Type": "tunnel", "color": colors.purple, "city_A": "Zurich", "city_B": "Marseille"})
	_add_path({ "pos": Vector3(-19, 0, 3), "Rotation": -30, "NbrSpace": 4, "Type": "normal", "color": colors.grey, "city_A": "Marseille", "city_B": "Paris"})
	_add_path({ "pos": Vector3(-18, 0, 1), "Rotation": -60, "NbrSpace": 3, "Type": "tunnel", "color": colors.grey, "city_A": "Paris", "city_B": "Zurich"})
	_add_path({ "pos": Vector3(-20, 0, -7), "Rotation": 60, "NbrSpace": 2, "Type": "normal", "color": colors.green, "city_A": "Bruxelles", "city_B": "Dieppe"})
	_add_path({ "pos": Vector3(-19.5, 0, -5), "Rotation": 15, "NbrSpace": 2, "Type": "normal", "color": colors.yellow, "city_A": "Paris", "city_B": "Bruxelles"})
	_add_path({ "pos": Vector3(-18, 0, -5), "Rotation": 15, "NbrSpace": 2, "Type": "normal", "color": colors.red, "city_A": "Paris", "city_B": "Bruxelles"})
	_add_path({ "pos": Vector3(-27, 0, -3), "Rotation": 75, "NbrSpace": 2, "Type": "normal", "color": colors.orange, "city_A": "Brest", "city_B": "Dieppe"})
	_add_path({ "pos": Vector3(-23.5, 0, -11), "Rotation": 10, "NbrSpace": 3, "Type": "ferry", "color": colors.grey, "city_A": "Dieppe", "city_B": "London"})
	_add_path({ "pos": Vector3(-25, 0, -11), "Rotation": 10, "NbrSpace": 3, "Type": "ferry", "color": colors.grey, "city_A": "Dieppe", "city_B": "London"})
	_add_path({ "pos": Vector3(-21, 0, -13), "Rotation": -80, "NbrSpace": 2, "Type": "double_ferry", "color": colors.grey, "city_A": "Amsterdam", "city_B": "London"})
	_add_path({ "pos": Vector3(-28.5, 0, -24), "Rotation": -20, "NbrSpace": 5, "Type": "normal", "color": colors.black, "city_A": "Edinburgh", "city_B": "London"})
	_add_path({ "pos": Vector3(-27, 0, -25), "Rotation": -20, "NbrSpace": 5, "Type": "normal", "color": colors.orange, "city_A": "Edinburgh", "city_B": "London"})
	_add_path({ "pos": Vector3(-17, 0, -10), "Rotation": 25, "NbrSpace": 1, "Type": "normal", "color": colors.black, "city_A": "Amsterdam", "city_B": "Bruxelles"})
	_add_path({ "pos": Vector3(-12, 0, -3), "Rotation": 65, "NbrSpace": 3, "Type": "normal", "color": colors.orange, "city_A": "Paris", "city_B": "Frankfurt"})
	_add_path({ "pos": Vector3(-12, 0, -4.5), "Rotation": 65, "NbrSpace": 3, "Type": "normal", "color": colors.white, "city_A": "Paris", "city_B": "Frankfurt"})
	_add_path({ "pos": Vector3(-16, 0, -7), "Rotation": -60, "NbrSpace": 2, "Type": "normal", "color": colors.blue, "city_A": "Bruxelles", "city_B": "Frankfurt"})
	_add_path({ "pos": Vector3(-14.5, 0, -11), "Rotation": -40, "NbrSpace": 3, "Type": "normal", "color": colors.white, "city_A": "Amsterdam", "city_B": "Frankfurt"})
	_add_path({ "pos": Vector3(-9, 0, -9), "Rotation": 15, "NbrSpace": 2, "Type": "normal", "color": colors.green, "city_A": "Essen", "city_B": "Frankfurt"})
	_add_path({ "pos": Vector3(-14, 0, -12.5), "Rotation": -80, "NbrSpace": 2, "Type": "normal", "color": colors.yellow, "city_A": "Amsterdam", "city_B": "Essen"})
	_add_path({ "pos": Vector3(-7, 0, 1), "Rotation": 45, "NbrSpace": 2, "Type": "tunnel", "color": colors.yellow, "city_A": "Zurich", "city_B": "Munich"})
	_add_path({ "pos": Vector3(-9, 0, -3), "Rotation": -45, "NbrSpace": 2, "Type": "normal", "color": colors.purple, "city_A": "Frankfurt", "city_B": "Munich"})
	_add_path({ "pos": Vector3(-9, 0, 6.5), "Rotation": -75, "NbrSpace": 2, "Type": "tunnel", "color": colors.green, "city_A": "Venezia", "city_B": "Zurich"})
	_add_path({ "pos": Vector3(-3.5, 0, 11), "Rotation": -5, "NbrSpace": 2, "Type": "normal", "color": colors.black, "city_A": "Venezia", "city_B": "Roma"})
